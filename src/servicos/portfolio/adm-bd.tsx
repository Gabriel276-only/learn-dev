...
<p className="text-lg max-w-2xl  text-gray-300">
            A administração de banco de dados envolve a gestão, manutenção e segurança de sistemas de 
            banco de dados. Isso inclui tarefas como backup, recuperação, otimização de desempenho e 
            controle de acesso.
          </p>
