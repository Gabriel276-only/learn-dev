...
function App() {
  ...
  return (
    <div className="h-screen relative">
      {/* Cursor customizado */}
      <div className="cursor h-6 w-6 rounded-full bg-cyan-300 fixed z-50 pointer-events-none mix-blend-plus"></div>
        ...
        <section id="portfolio" className="py-20 px-10 bg-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {["Projeto A", "Projeto B", "Projeto C", "Projeto D", "Projeto E", "Projeto F"].map((projeto, index) => (
              <motion.div key={index} whileHover={{ scale: 1.05 }} className="p-6 bg-gray-700 rounded-lg text-center shadow-xl border border-gray-600 hover: hover:border-blue-400 transition-all">
